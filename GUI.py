...
light_telnet = light_obj_telnet.create_oval(
    14, 14, 26, 26, fill='red', tags='light_telnet')
light_obj_telnet.pack(side=LEFT)


light_obj_FTP = Canvas(frame_IP, width=40, height=40)
light_FTP = light_obj_FTP.create_oval(
    14, 14, 26, 26, fill='red', tags='light_FTP')
...
label_version_select = Label(
    frame_version_select,
    text='Version',
    width=6,
    height=2)
label_version_select.pack(side=LEFT)
rb_loxoll = Radiobutton(
    frame_version_select,
    variable=version,
    text='Loxoll',
    value='loxoll')
rb_loxoll.pack(side=LEFT)
rb_vicom = Radiobutton(
    frame_version_select,
    variable=version,
    text='Vicom',
    value='vicom')
...
b_config_T = Button(
    frame_operation,
    text="T mode",
    command=lambda: start_with_threading(
        transfer,
        ('target',
         )),
    width=5,
